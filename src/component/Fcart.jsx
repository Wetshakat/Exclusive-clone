      ...
      {showModal && selectedProduct && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-lg p-6 w-[90%] max-w-md relative">
            ...
            <img src={selectedProduct.image} alt={selectedProduct.title} className="h-40 mx-auto object-contain" />
            <h2 className="text-lg font-bold mt-4 text-center">{selectedProduct.title}</h2>
            <p className="text-gray-600 text-sm mt-2 text-center">{selectedProduct.description}</p>
            <div className="text-center mt-4">
              <span className="text-red-600 font-bold text-lg">${selectedProduct.price}</span>
            </div>
            <button
              onClick={() => {
